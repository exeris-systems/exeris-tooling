...
2. **`VerifyCapabilitiesMojoTest.CapTierWallGuard`** pins the mojo control flow: run order versus graph validation, both skip toggles, and the failure-type mapping.
